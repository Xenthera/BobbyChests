...
public final class WoodenChestMenuProvider extends AbstractTieredChestMenuProvider {
    public WoodenChestMenuProvider(Component title, GlobalTieredChestContainer container, BlockPos pos, AbstractTieredChestBlockEntity chest) {
