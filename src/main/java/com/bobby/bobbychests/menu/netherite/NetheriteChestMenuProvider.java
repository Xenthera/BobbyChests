package com.bobby.bobbychests.menu.netherite;
...
public final class NetheriteChestMenuProvider extends AbstractTieredChestMenuProvider {
    public NetheriteChestMenuProvider(Component title, GlobalTieredChestContainer container, BlockPos pos, AbstractTieredChestBlockEntity chest) {
