...
public final class FluidChestMenu extends AbstractResourceChestMenu {

    public static FluidChestMenu clientConstructor(int syncId, Inventory playerInventory, RegistryFriendlyByteBuf buf) {
    ...
    public FluidChestMenu(
            ...
            int maxChannelId,
            ChestTier tier) {
        super(ModMenus.FLUID_CHEST_MENU.get(), syncID, playerInventory, container, upgradeContainer,
    ...
    public int getCapacityMb() {
        return this.getTier().fluidCapacityMb();
    }
}
